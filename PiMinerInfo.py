...
class PiMinerInfo:
  ...
  self.host = self.get_ipaddress()
    ...
    def matching_pools(self, p1, p2=None):
  	p1 = self.conv_prio_dict(p1)
  	p2 = self.conv_prio_dict(p2)
	...
	#self.matching_pools(self.parse_pools_list(s))
